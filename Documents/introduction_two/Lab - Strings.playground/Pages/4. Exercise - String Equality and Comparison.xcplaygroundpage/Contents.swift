 ...
 */
let nameInCaps1 = "Thenea Sun"
let name1 = "thenea sun"
if nameInCaps1.lowercased() == name1.lowercased() {
    print(nameInCaps1.lowercased(), "and", name1.lowercased(), "are the same")
} else {
    print(nameInCaps1.lowercased(), "and", name1.lowercased(), "are not the same")
}
/*:
